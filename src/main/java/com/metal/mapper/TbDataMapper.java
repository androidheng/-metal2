...
public interface TbDataMapper {
    ...
    List<TbData> findYunDay(@Param("date") String date,@Param("cid") Integer cid);
    List<TbData> findYunMonth(@Param("date") String date,@Param("cid") Integer cid);
    List<TbData> findYunYear(@Param("date") String date,@Param("cid") Integer cid);
