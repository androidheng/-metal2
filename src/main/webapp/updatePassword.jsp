...
<body class="login-wrap">
    <div class="login-container">
        <form class="login-form layui-form"  action="" lay-filter="formTest">
           
            <div class="layui-form-item">
                <label class="layui-form-label">用户名</label>
                  <div class="layui-input-block">
                    <input type="text" id="username" name="username" lay-verify="username" disabled  class="layui-input">
                  </div>
            </div>
           <div class="layui-form-item">
          ...
          $.ajax({
            ...
            success:function(res){//res为相应体,function为回调函数
              if(res.success){
                ...
                location.href="<%=basePath%>"+actions[usertype]+"/index.jsp";
