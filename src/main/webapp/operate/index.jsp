            ...
            <div class="layui-side-scroll">
                ...
                <ul id="Nav" class="layui-nav layui-nav-tree">  
                    <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd><a href="<%=basePath%>operate/historyData.jsp">开采数据查询</a></dd>
                    ...
                    <li class="layui-nav-item">
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd><a href="<%=basePath%>operate/baseData.jsp">开采数据管理</a></dd>
                                <dd><a href="<%=basePath%>operate/carryData.jsp">运载数据管理</a></dd>
                                <dd><a href="<%=basePath%>operate/oreBlending.jsp">装载数据管理</a></dd>
                                <dd><a href="<%=basePath%>operate/wareHouse.jsp">卸载数据管理</a></dd>
                                <dd><a href="<%=basePath%>operate/AnnualPlanData.jsp">计划数据管理</a></dd>
                            </dl>
                    </li> 
                  </ul>
           </div>
