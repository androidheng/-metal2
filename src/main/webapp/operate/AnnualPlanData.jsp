...
<body class="layui-view-body">
        ...
        <form class="layui-form" action="" lay-filter="formTest">
          ...
          <div class="layui-form-item">
           ...
           <div class="layui-form-item">
               ...
               <div class="layui-input-block">
                 <input type="number" name="machine1"  required  lay-verify="required" class="layui-input spacil">升
               </div>
           </div>
            <div class="layui-form-item">
               <label class="layui-form-label">卡车耗油量</label>
               <div class="layui-input-block">
                 <input type="number" name="machine2"  required  lay-verify="required" class="layui-input spacil">升
               </div>
           </div>
            <div class="layui-form-item">
               <label class="layui-form-label">设备总费用</label>
               <div class="layui-input-block">
    ...
    <script type="text/html" id="toolbarDemo">
     <div class="layui-btn-container">
        <button class="layui-btn layui-btn-sm" lay-event="add">添加年度计划数据</button>
     </div>
    </script>
    	        ...
    	        ,content: $("#box"),
    	         success:function(layero, index){
                      ...
                      form.on('submit(demo1)', function(data){
                    	  $.ajax({
                              url:"<%=basePath%>yearplan/addOrUpdate",
                              type:'post',//method请求方式，get或者post
                              dataType:'json',//预期服务器返回的数据类型
