...
<body class="layui-view-body">
        ...
        <form class="layui-form" action="" lay-filter="formTest"  id="addGoodsForm">
           ...
           <div class="layui-form-item">
               ...
               <div class="layui-input-block">
                 <input type="text" name="carname"  required  lay-verify="required" class="layui-input">
               </div>
           </div>
           <div class="layui-form-item">
               <label class="layui-form-label">承载最大吨数</label>
               <div class="layui-input-block">
    ...
    layui.use('table', function(){
        ...
        table.render({
          ...
          ,url:'<%=basePath%>car/search'
          ,cols: [[ //标题栏
             {field: 'carname', title: '车牌号' }
            ,{field: 'maxcount', title: '承载最大吨数'}
