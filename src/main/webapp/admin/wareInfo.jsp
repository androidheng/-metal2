...
<body class="layui-view-body">
        ...
        <form class="layui-form" action="" lay-filter="formTest"  id="addGoodsForm">
           ...
           <div class="layui-form-item">
               ...
               <div class="layui-input-block">
                 <input type="text" name="warename"  required  lay-verify="required" class="layui-input">
               </div>
           </div>
           <div class="layui-form-item">
    ...
    layui.use('table', function(){
        ...
        table.render({
          ...
          ,url:'<%=basePath%>warehouse/search'
          ,cols: [[ //标题栏
             {field: 'warename', title: '仓库名' }
            ,{field: 'city', title: '所在城市'}
            ,{field: 'lat', title: '经度'}
            ,{field: 'lon', title: '纬度'}
            ,{field: 'maxcount', title: '最大容量'}
    	        ...
    	        ,content: $("#box"),
    	         success:function(layero, index){
                      ...
                      form.on('submit(demo1)', function(data){
                    	  ...
                    	  $.ajax({
                              url:"<%=basePath%>warehouse/addOrUpdate",
                              type:'post',//method请求方式，get或者post
                              dataType:'json',//预期服务器返回的数据类型
