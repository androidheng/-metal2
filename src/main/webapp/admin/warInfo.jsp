...
<body class="layui-view-body">
     <div class="layui-content" id="box" style="display:none">
        <form class="layui-form" action="" lay-filter="formTest"  id="addGoodsForm">
           ...
           <div class="layui-form-item">
               <label class="layui-form-label">挖机名称</label>
               <div class="layui-input-block">
                 <input type="text" name="waname"  required  lay-verify="required" class="layui-input">
               </div>
           </div>
           <div class="layui-form-item">
               <label class="layui-form-label">出矿能力</label>
               <div class="layui-input-block">
    ...
    layui.use('table', function(){
        ...
        table.render({
          ...
          ,url:'<%=basePath%>war/search'
          ,cols: [[ //标题栏
             {field: 'waname', title: '挖机名称' }
            ,{field: 'maxcount', title: '出矿能力'}
